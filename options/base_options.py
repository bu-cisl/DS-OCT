...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='CUT_newdata_FFOV', help='name of the experiment. It decides where to store samples and models')
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='cutreg_twostage', help='chooses which model to use.')
        ...
        parser.add_argument('--netG', type=str, default='resnet_9blocks', choices=['resnet_9blocks', 'resnet_6blocks', 'unet_256', 'unet_128', 'stylegan2', 'smallstylegan2', 'resnet_cat', 'LPTN'], help='specify generator architecture')
        ...
        parser.add_argument('--img_height', type=int, default=512, help='The input image height')
        parser.add_argument('--img_width', type=int, default=512, help='The input image width')
